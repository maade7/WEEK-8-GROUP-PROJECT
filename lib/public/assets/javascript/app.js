...
function setHTML() {
    ...
    row.append($('<td><button type="button" class="btn btn-xs btn-warning fav" fav="' + fav + '" id="' + beerID + '">★</button></td>'))
        .append($('<td><a href="#' + beerID + 'collapse" data-parent="#accordion" data-toggle="collapse" class="accordion-toggle">' + name + '</td>'))
        .append($('<td>' + style + '</td>'))
    ...
    info.append($('<td colspan=6><div id="' + beerID + 'collapse" class="row panel-collapse collapse"><div class="col-xs-4"><img src="' + labels + '"></div><div class="col-xs-8"><p>' + description + '<br><br>' + styleDescription + '</p><textarea class="form-control" id="' + beerID + 'note">' + note + '</textarea></div></div></td>'))
